...
Const_String_Blob_Ptr String_Blob::cbegin()
{
    return Const_String_Blob_Ptr(*this);
}

Const_String_Blob_Ptr String_Blob::cend()
{
    return Const_String_Blob_Ptr(*this, data->size());
}
...
std::string& String_Blob::operator[](size_t idx)
{
    return data->at(idx);
}

const std::string& String_Blob::operator[](size_t idx) const
{
    return data->at(idx);
}
